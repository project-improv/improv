...
class LMDBAcquirer(Actor):
    ...
    def runAcquirer(self):
        ...
        if self.frame_current < len(self.data):
            ...
            object_id = self.client.put(frame, 'acq_raw'+self.frame_current)
            ...
            logger.error('Done with all available frames: {}'.format(self.frame_current))
            self.done = True
            self.data = None
