...
class Bubblewrap(Actor):
    ...
    def putOutput(self):
        ...
        ids.append(
            [
                self.client.put(self.bw.A, 'A' + str(self.frame_number)),
                'A' + str(self.frame_number),
            ]
        )
        ids.append(
            [
                self.client.put(self.bw.L, 'L' + str(self.frame_number)),
                'L' + str(self.frame_number),
            ]
        )
        ids.append(
            [
                self.client.put(self.bw.mu, 'mu' + str(self.frame_number)),
                'mu' + str(self.frame_number),
            ]
        )
        ids.append(
            [
                self.client.put(self.bw.n_obs, 'n_obs' + str(self.frame_number)),
                'n_obs' + str(self.frame_number),
            ]
        )
        ids.append(
            [
                self.client.put(self.bw.pred, 'pred' + str(self.frame_number)),
        ...
        ids.append(
            [
                self.client.put(
                    self.bw.entropy_list, 'entropy' + str(self.frame_number)
                ),
