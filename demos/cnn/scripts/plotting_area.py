...
def plot_area(data, cmap, labels, title, xticks, out_path, file_name, context='poster', rc=None, save=False):
    '''
    '''
...
analysis = ['to_device', 'inference_time', 'out_to_np', 'put_out_store', 'put_q_out', 'pred_time', 'put_pred_store']
...
color_map_anal = ['#9a79d3', '#a78ad8', '#b39bde', '#c0abe3', '#ccbce9', '#d9cdee', '#e5ddf4', '#f2eef9']

# Area Plot
x = range(2, 300)
y = [acq[2:], preproc[2:], analysis[2:]]
plt.stackplot(x, y, labels=['Acquisition', 'Preprocessing', 'Analysis'], colors=color_map_full)
