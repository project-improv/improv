...
"}")
        ...
        self.checkBox.setObjectName("checkBox") #end setup of top right?
        self.frame_4 = QtWidgets.QFrame(self.centralwidget) #top left panels?
        self.frame_4.setGeometry(QtCore.QRect(760, 280, 341, 321))
        self.frame_4.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_4.setObjectName("frame_4")
        self.rawplot_3 = ImageView(self.frame_4) #plot on  top left panel (Population)
        self.rawplot_3.setGeometry(QtCore.QRect(10, 10, 331, 311))
        self.rawplot_3.setObjectName("rawplot_3")
        self.frame_5 = QtWidgets.QFrame(self.centralwidget) #middle panel (Selected Neighbors)
        self.frame_5.setGeometry(QtCore.QRect(390, 280, 341, 321))
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.rawplot_2 = ImageView(self.frame_5) #plot of bottom panel
        self.rawplot_2.setGeometry(QtCore.QRect(10, 10, 331, 311))
        self.rawplot_2.setObjectName("rawplot_2")
        self.frame_3 = QtWidgets.QFrame(self.centralwidget) #sets up top right box (targeting Sequence)
        self.frame_3.setGeometry(QtCore.QRect(760, 20, 341, 241))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.slider = QtWidgets.QSlider(self.frame_3) #sets sliders for targeting sequences
        self.slider.setGeometry(QtCore.QRect(30, 70, 131, 22))
        self.slider.setOrientation(QtCore.Qt.Horizontal)
        self.slider.setObjectName("slider")
        self.label = QtWidgets.QLabel(self.frame_3) #give text label
        ...
        self.label_6 = QtWidgets.QLabel(self.frame_3) #label frame 3 with label "Number of Neurons"
        ...
        self.label_7 = QtWidgets.QLabel(self.frame_3) #label frame 3 with label "direction"
        ...
        self.label_2 = QtWidgets.QLabel(self.centralwidget) #central widget is setup
        ...
        self.label_3 = QtWidgets.QLabel(self.centralwidget) #labeling something as "selected neuron"
        ...
        self.label_4 = QtWidgets.QLabel(self.centralwidget) #labeling something "Raw Frame"
