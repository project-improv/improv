...
def plot_hist(data, title, out_plots_path, file_name, bins='auto', range=None):
    ...
    plt.savefig(os.path.join(out_plots_path, file_name), dpi=300)
...
acq_titles = ['Image -> Store Time', 'Image+Label -> q_out Time', 'Total Acquisition Time', 'Label -> Store Time']
acq_files = ['put_img_time.png', 'put_out_time.png', 'acq_total_times.png', 'put_lab_time.png']
...
proc_keys = ['get_img_out', 'proc_img_time', 'to_device', 'inference_time', 'out_to_np', 'put_out_store', 'put_q_out', 'pred_time', 'put_pred_store', 'total_times']
proc_titles = ['Stored Image -> Processor Time', 'Process Image Time', 'Image -> Device Time', 'Inference Time', 'Output -> np.array Time', 'Output -> Store', 'Output -> q_out', 'Prediction Time', 'Classification/Prediction Output -> Store', 'Total Processing Time']
proc_files = ['get_img_out.png', 'proc_img_time.png', 'to_device.png', 'inference_time.png', 'out_to_np.png', 'put_out_store.png', 'put_q_out.png', 'pred_time.png', 'put_pred_store.png', 'total_proc_time.png']
